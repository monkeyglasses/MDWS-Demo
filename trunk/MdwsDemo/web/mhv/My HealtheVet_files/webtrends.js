...
function WebTrends(){
	...
	//***********************
	//added to send to test/dev data to a different DCSids
	var docHost = window.location.hostname.toLowerCase();
	//replace uat.dignityplanning.com with the test/dev domain for the Veterans Admin.
	if ((docHost.indexOf("mhv-intb.myhealth.va.gov")!=-1)||(docHost.indexOf("mhv-syst.myhealth.va.gov")!=-1)||(docHost.indexOf("ppd.myhealth.va.gov")!=-1)||(docHost.indexOf("preview.myhealth.va.gov")!=-1)||(docHost.indexOf("localhost")!=-1)) {
                 this.dcsid="dcsys38p710000o261jiz29tw_7c3v";} else {this.dcsid="dcs9yfa75000008i39qfxq8tw_4t5d";} 
  	//End modification for dev vs. production
  	//***********************
  	
  	//default entry
  	//this.dcsid="dcs9yfa75000008i39qfxq8tw_4t5d";
...
//	added to use dcsQP function to set dcsuri = to value in _pageLabel and contentPage param
	DCS.dcsuri="/"+this.dcsQP("_pageLabel");
	DCS.pagecontent=this.dcsQP("contentPage");
	DCS.dcsuri=DCS.dcsuri+"/"+DCS.pagecontent;
	if (DCS.dcsuri=="//"){
		DCS.dcsuri=window.location.pathname;
	}
// end additions
